...
c-----------------------------------------------------------------------
	program main
        ...
        ! parameter (nstar=900,IDeigen=23)
        parameter (nstarMax=100000,IDeigen=23)
     ...
     c         dx,dy,phi,pi,scale,x2,y2
        ...
        inputXY="gridXY2_BCS_shifted"
        inputE12="/data/mzm/BCS/BCS_r_e12/Xmat"
        ! inputE12="/data/mzm/BCS/BCS_r_e12/eigenVecEM"
